...
/**
 * This class represents a descriptor of a physical server. Thus, it indicates
...
public class ServerDescriptor extends HostDescriptor {
	...
	/**
	 * This attribute is redundant. It is used to optimize the search of the least
	 * busy server and it must be kept updated manually using subscribe() and
	 * unsubscribe() methods.
	 */
	...
	/**
	 * Keep count of subscribers count by signaling a new subscription to this
	 * server.
	 */
	...
	/**
	 * Keep count of subscribers count by signaling an unsubscription to this
	 * server.
	 */
	...
	public boolean equals(ServerDescriptor second) {
		return second.getMacAddress().equals(getMacAddress()) || second.getIPAddress().equals(getIPAddress());
	}
